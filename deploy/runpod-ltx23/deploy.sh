...
# ---- Config ----
REGISTRY="ghcr.io/m0nklabs/oelala-ltx23-worker"
TEMPLATE_ID="${RUNPOD_LTX23_TEMPLATE_ID:-c1fz26l07d}"
ENDPOINT_ID="${RUNPOD_LTX23_ENDPOINT_ID:-ctpoa610dva4ww}"
...
if [[ "$TEMPLATE_ID" == "PLACEHOLDER" ]] && ! $DRY_RUN; then
    echo "❌ TEMPLATE_ID is PLACEHOLDER. Set RUNPOD_LTX23_TEMPLATE_ID or update this script."
...
echo "============================================"
echo "🚀 RunPod LTX-2.3 Worker Deploy"
echo "============================================"
