...
WORKFLOW_PATH = (
    Path.home()
    / "oelala/ComfyUI/user/default/workflows/WAN2.2-I2V-DisTorch2-NEW_api.json"
)
...
def main():
    ...
    print("=" * 60)
    print("GPUs: RTX 3060 (12GB) + RTX 5060 Ti (16GB)")
    print("Model: WAN 2.2 I2V 14B GGUF Q6_K")
    print("Allocation: cuda:0=8GB, cuda:1=12GB, cpu=rest")
    print("=" * 60)
    ...
    for r in results:
        ...
        print(
            f"{r['desc']:<30} {status:<8} {r['duration']:.1f}s      {r['peak_gpu0_mb']:<10} {r['peak_gpu1_mb']:<10}"
        )
