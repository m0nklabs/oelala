...
export const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { id: TOOL_IDS.VIDEO_TO_VIDEO, label: 'Video to Video', status: 'soon' },
    ],
  },
  {
    id: 'image-tools',
    ...
    items: [
      ...
      { id: TOOL_IDS.IMAGE_TO_IMAGE, label: 'Image to Image', status: 'soon' },
      { id: TOOL_IDS.REFRAME, label: 'Reframe', status: 'soon' },
      { id: TOOL_IDS.FACE_SWAP, label: 'Face Swap', status: 'soon' },
      { id: TOOL_IDS.UPSCALER, label: 'Upscaler', status: 'soon' },
    ],
  },
  {
    id: 'prompt-tools',
